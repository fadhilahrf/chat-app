...
import com.company.chatapp.service.MessageService;
...
/**
 * REST controller for managing {@link com.company.chatapp.domain.Message}.
 */
@RestController
...
public class MessageResource {
    ...
    public MessageResource(MessageService messageService, MessageRepository messageRepository, SimpMessagingTemplate messagingTemplate) {
    ...
    public ResponseEntity<MessageDTO> updateMessage(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, messageDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<MessageDTO> partialUpdateMessage(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, messageDTO.getId())
        );
    }
